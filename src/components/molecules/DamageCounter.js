    ...
    return (
        <div className="damage-counter-container">
            ...
            <div className="dc-img-container">
                <img className="dc-lft-arrow" onClick={lftDamage} src={require('../../assets/images/arrow.png')} />
                <div className="dc-counter">
                    <img className="dc-strength" src={require('../../assets/images/strength.png')} />
                    <span className="dc-img-txt">{damage ? damage : 0}</span>
                </div>
                <img className="dc-rht-arrow" onClick={rhtDamage} src={require('../../assets/images/arrow.png')} />
            </div>
        </div>
    );
};
